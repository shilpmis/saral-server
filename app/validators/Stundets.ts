...
export const CreateValidatorForUpload = vine.compile(
  vine.object({
    students_data: vine.object({
      ...
      aadhar_no: vine.number().unique({ table: 'students', column: 'aadhar_no' }).nullable(),
    ...
    student_meta_data: vine
      .object({
        aadhar_dise_no: vine
          .number()
          .nullable()
          .optional(), // Making it both nullable AND optional for maximum flexibility
    ...
    .array(
      vine.object({
        ...
        students_data: vine.object({
          ...
          aadhar_no: vine.number().unique({ table: 'students', column: 'aadhar_no' }),
  ...
  vine.object({
    ...
    students_data: vine
      .object({
        ...
        aadhar_no: vine.number().unique({ table: 'students', column: 'aadhar_no' }).optional(),
